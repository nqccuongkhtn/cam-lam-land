          ...
          <section className="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-2">
                <svg width="80" height="80" viewBox="0 0 96 96" style={{ filter: 'drop-shadow(0 2px 5px rgba(0,0,0,.3))' }}><defs><clipPath id="cpv"><circle cx="48" cy="48" r="29" /></clipPath><path id="tpv" d="M 9 48 A 39 39 0 0 1 87 48" /><path id="bpv" d="M 87 48 A 39 39 0 0 0 9 48" /></defs><circle cx="48" cy="48" r="47" fill="#0A2540" stroke="#C8A14B" strokeWidth="1.5" />{imageUrl ? <image href={imageUrl} x="18" y="18" width="60" height="60" clipPath="url(#cpv)" preserveAspectRatio="xMidYMid slice" /> : <text x="48" y="50" textAnchor="middle" dominantBaseline="middle" fontSize="24" fontWeight="800" fill="#C8A14B">{(name || 'C').charAt(0).toUpperCase()}</text>}<circle cx="48" cy="48" r="29.6" fill="none" stroke="#C8A14B" strokeWidth="1" /><text fontSize="8.6" fontWeight="800" fill="#C8A14B"><textPath href="#tpv" startOffset="50%" textAnchor="middle">{(name || 'Tên sales').slice(0, 22)}</textPath></text><text fontSize="8.6" fontWeight="700" fill="#fff"><textPath href="#bpv" startOffset="50%" textAnchor="middle">{phone || 'SĐT'}</textPath></text></svg>
