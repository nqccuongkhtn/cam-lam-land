          ...
          <section className="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-2">
                <svg width="118" height="118" viewBox="0 0 100 100" style={{ filter: 'drop-shadow(0 2px 6px rgba(0,0,0,.3))' }}><defs><clipPath id="cpv"><circle cx="50" cy="50" r="28" /></clipPath><path id="tpv" d="M 11 50 A 39 39 0 0 1 89 50" /><path id="bpv" d="M 11 50 A 39 39 0 0 0 89 50" /></defs><circle cx="50" cy="50" r="49" fill="#0A2540" /><circle cx="50" cy="50" r="47.5" fill="none" stroke="#C8A14B" strokeWidth="1" />{imageUrl ? <image href={imageUrl} x="18" y="18" width="64" height="64" clipPath="url(#cpv)" preserveAspectRatio="xMidYMid slice" /> : <text x="50" y="51" textAnchor="middle" dominantBaseline="middle" fontSize="26" fontWeight="800" fill="#C8A14B">{(name || 'C').charAt(0).toUpperCase()}</text>}<circle cx="50" cy="50" r="29" fill="none" stroke="#C8A14B" strokeWidth="1.4" /><text fontSize="11" fontWeight="800" fill="#fff"><textPath href="#tpv" startOffset="50%" textAnchor="middle" textLength="96" lengthAdjust="spacingAndGlyphs">{(name || 'Tên sales').slice(0, 26)}</textPath></text><text fontSize="11" fontWeight="800" fill="#fff"><textPath href="#bpv" startOffset="50%" textAnchor="middle" textLength="86" lengthAdjust="spacingAndGlyphs">{phone || 'SĐT'}</textPath></text><text x="7.5" y="50" textAnchor="middle" dominantBaseline="central" fontSize="8" fill="#C8A14B">★</text><text x="92.5" y="50" textAnchor="middle" dominantBaseline="central" fontSize="8" fill="#C8A14B">★</text></svg>
