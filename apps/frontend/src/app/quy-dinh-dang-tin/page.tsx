  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        { h: 'Nội dung bị cấm', body: <ul className="list-disc pl-5 space-y-1"><li>Tin trùng lặp, đăng lại nhiều lần gây spam.</li><li>Tin giả, bất động sản không có thật.</li><li>Bất động sản đang tranh chấp, kê biên nhưng không nêu rõ.</li><li>Nội dung vi phạm pháp luật, trái thuần phong mỹ tục.</li></ul> },
